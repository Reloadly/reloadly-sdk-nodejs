import { CustomRequest } from "../Internal/Dto/Request/CustomRequest";
import { ProxyOptions } from "../Internal/Dto/Request/ProxyOptions";
import { ProxyOptionsAuth } from "../Internal/Dto/Request/ProxyOptionsAuth";
...
describe('CustomRequest Tests', function () {
    it('Get Properties', async function () {
        ...
        var req = new CustomRequest("https://reloadly.com", "POST");
        req.addHeader("test-header", "test-header-val");
        req.proxy(new ProxyOptions("reloadly-proxy.com", "81", "https",
            new ProxyOptionsAuth("test-user", "test-pass")));
    ...
    it('Make Request', async function () {
        ...
        var req = new CustomRequest("https://run.mocky.io/v3/07800d21-740a-44ed-b550-cf7ec646711e", "GET");
    ...
    it('Throw Exception When Invalid URL', async function () {
        ...
        // returns 404
        var req = new CustomRequest("https://run.mocky.io/v3/a1a6ff7b-128f-4fb9-91dc-184a0b138155", "GET");
    ...
    it('Throw Exception When Invalid Proxy', async function () {
        ...
        var req = new CustomRequest("https://error.com", "GET");
        req.proxy(new ProxyOptions("invalid-proxy-host", "1"));
